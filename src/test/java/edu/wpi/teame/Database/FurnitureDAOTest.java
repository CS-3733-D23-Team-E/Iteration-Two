...
public class FurnitureDAOTest {
    ...
    public void testGetAddDelete() {
        ...
        SQLRepo.INSTANCE.deleteFurnitureRequest(
                new FurnitureRequestData(
                        ...
                        "for 2 hours",
                        FurnitureRequestData.Status.DONE));
        List<FurnitureRequestData> furnitureRequestDeleted = SQLRepo.INSTANCE.getFurnitureRequestsList();
    ...
    public void testImportExport() {
        ...
        SQLRepo.INSTANCE.importFromCSV(
                SQLRepo.Table.FURNITURE_REQUESTS, "C:\\Users\\thesm\\OneDrive\\Desktop\\CS 3733\\FurnitureExport");
