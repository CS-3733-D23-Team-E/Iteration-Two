...
public class ConferenceRequestData {
    public enum Status {
        PENDING,
        IN_PROGRESS,
        DONE;
    ...
    public ConferenceRequestData(int requestID, String name, String room, String deliveryDate, String deliveryTime, String staff, String roomRequest, String notes, Status requestStatus){
